...
### 4.1.1. Deploying the metrics server
...
As clearly stated in the Kubernetes documentation, you can specify two kind of
...
be terminated or evicted. Liveness checks can be used
...
### 4.2.3. Inspect available resources
...
(e.g., 100m), adding the resources section as showed in the pod example before:
```sh
...
## 4.4. Autoscaling pods based on CPU usage
...
php-apache Deployment/php-apache  305% / 25%  305%     1        10       7
```
